...
This chapter contains \protect\hyperlink{basic}{basic commands} and \protect\hyperlink{advanced}{advanced commands}.
...
There are three Matplotlib cheatsheets for beginners (Figure \ref{fig:beginner}) . and intermediate users (Figure \ref{fig:intermediate}), and some tips and tricks (Figure \ref{fig:tips}).
