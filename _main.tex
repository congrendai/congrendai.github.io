...
\hypertarget{linux}{%
\chapter{Linux Commands}\label{linux}}

The explanation of commands is behind \textbf{\emph{\#}}.\\
\textbf{\emph{demo.txt}} or \textbf{\emph{demo.zip}} is a file name.\\
\textbf{\emph{demo}} or \textbf{\emph{desktop}} is a directory name.
...
\begin{Shaded}
\begin{Highlighting}[]
\BuiltInTok{pwd} \CommentTok{\# check the current path from the root}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\BuiltInTok{cd}\NormalTok{ / }\CommentTok{\# change directory to the root directory}
\BuiltInTok{cd}\NormalTok{ .. }\CommentTok{\# change directory to the upper directory}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{cat}\NormalTok{ demo.txt }\CommentTok{\# see the contents of a file}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{head}\NormalTok{ demo.txt }\CommentTok{\# check first 10 lines of the contents}
\FunctionTok{head} \AttributeTok{{-}n}\NormalTok{ 20 demo.txt }\CommentTok{\# check 20 lines of the contents}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{tail}\NormalTok{ demo.txt }\CommentTok{\# check last 10 lines of the contents}
\FunctionTok{tail} \AttributeTok{{-}n}\NormalTok{ 20 demo.txt }\CommentTok{\# check 20 lines of the contents}
\FunctionTok{tail} \AttributeTok{{-}f}\NormalTok{ demo.txt }\CommentTok{\# check the added contents to the file consistently}
\end{Highlighting}
\end{Shaded}
...
\hypertarget{advanced-commands}{%
\section{Advanced Commands}\label{advanced-commands}}
...
There are three Matplotlib cheatsheets for beginners and intermediate users, and some tips and tricks. \url{https://matplotlib.org/cheatsheets/}

\hypertarget{beginners}{%
\section{Beginners}\label{beginners}}

\includegraphics{matplotlib/handout-beginner.png}

\hypertarget{intermediate-users}{%
\section{Intermediate users}\label{intermediate-users}}

\includegraphics{matplotlib/handout-intermediate.png}

\hypertarget{tips-tricks}{%
\section{Tips \& Tricks}\label{tips-tricks}}

\includegraphics{matplotlib/handout-tips.png}
