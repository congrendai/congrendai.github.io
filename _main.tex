...
There are three Matplotlib cheatsheets for beginners \ref{fig:beginner}. and intermediate users \ref{fig:intermediate}, and some tips and tricks \ref{fig:tips}.
...
{\centering \includegraphics[width=1\linewidth]{matplotlib/handout-beginner} 
...
{\centering \includegraphics[width=1\linewidth]{matplotlib/handout-intermediate} 
...
{\centering \includegraphics[width=1\linewidth]{matplotlib/handout-tips} 
